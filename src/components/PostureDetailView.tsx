      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        <div className="bg-white border border-slate-200/90 rounded-xl p-3.5 shadow-2xs">
          ...
          <div className="flex items-baseline gap-2 mt-0.5">
            ...
            <span className="text-xs text-slate-600 font-medium">active items</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200/90 rounded-xl p-3.5 shadow-2xs">
          ...
          <div className="flex items-baseline gap-2 mt-0.5">
            ...
            <span className="text-[10px] text-rose-800 font-bold bg-rose-50 border border-rose-200 px-1 rounded">immediate SLA</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200/90 rounded-xl p-3.5 shadow-2xs">
          ...
          <div className="flex items-baseline gap-2 mt-0.5">
            ...
            <span className="text-xs text-slate-600 font-medium">requiring escalation</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200/90 rounded-xl p-3.5 shadow-2xs">
          ...
          <div className="flex items-baseline gap-2 mt-0.5">
            ...
            <span className="text-[10px] text-emerald-800 font-bold bg-emerald-50 border border-emerald-200 px-1 rounded">framework pass</span>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-8.5 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:bg-white text-slate-900 placeholder-slate-400 font-medium"
            />
          </div>

          <div className="flex items-center gap-2 flex-wrap">
            <div className="flex items-center gap-1.5 text-xs">
              <span className="text-[11px] font-bold text-slate-700 uppercase">Sev:</span>
              <select
            ...
            <div className="flex items-center gap-1.5 text-xs">
              <span className="text-[11px] font-bold text-slate-700 uppercase">BU:</span>
              <select
                value={selectedBU}
      ...
      <div className="bg-white border border-slate-200/90 rounded-xl overflow-hidden shadow-2xs">
        ...
        {filteredFindings.length === 0 ? (
          <div className="p-8 text-center text-slate-400 text-xs">
            ...
            <p className="font-bold text-slate-800 text-sm">No matching posture findings found</p>
            <p className="text-xs text-slate-600 mt-0.5">Try adjusting your search terms or filter criteria.</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs table-auto">
              <thead className="bg-slate-50 border-b border-slate-200 text-slate-700 font-bold uppercase text-[11px] tracking-wider">
                <tr>
                  <th className="py-2.5 px-3 break-words">Finding / ID</th>
                  <th className="py-2.5 px-2.5 break-words">Asset / Target</th>
                  <th className="py-2.5 px-2 break-words">Severity</th>
                  <th className="py-2.5 px-2.5 break-words">Timeline & SLA</th>
                  <th className="py-2.5 px-2.5 break-words">Time Since Open</th>
                  <th className="py-2.5 px-2.5 break-words">Owner (Assignee)</th>
                  <th className="py-2.5 px-2.5 break-words">Accountable Lead</th>
                  <th className="py-2.5 px-2.5 break-words">Status</th>
                  <th className="py-2.5 px-2.5 text-right break-words">Action</th>
                </tr>
              </thead>
                    ...
                    >
                      ...
                      <td className="py-2.5 px-3 max-w-[240px] break-words">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <span className="font-mono text-[11px] font-bold text-indigo-700 bg-indigo-50 px-1.5 py-0.5 rounded border border-indigo-200 break-all">
                            {item.id}
                          </span>
                          {item.cveOrRule && (
                            <span className="font-mono text-[10px] font-bold text-slate-800 bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200 break-all">
                              {item.cveOrRule}
                            </span>
                          )}
                        </div>
                        ...
                        <span className="text-[11px] text-slate-600 font-mono flex items-center gap-1 mt-0.5 break-words font-medium">
                      ...
                      <td className="py-2.5 px-2.5 max-w-[180px] break-words">
                        <span className="font-mono text-[11px] text-slate-900 bg-slate-100 px-1.5 py-0.5 rounded block break-all whitespace-normal border border-slate-200" title={item.assetTarget}>
                          {item.assetTarget}
                        </span>
                        <span className="text-xs text-slate-700 font-bold block mt-0.5 break-words">
                          {item.businessUnit}
                        </span>
                      </td>
                      ...
                      <td className="py-2.5 px-2 break-words">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase inline-block ${
                          ...
                          item.severity === 'High' ? 'bg-amber-100 text-amber-800 border border-amber-200' :
                          item.severity === 'Medium' ? 'bg-blue-100 text-blue-800 border border-blue-200' :
                      ...
                      <td className="py-2.5 px-2.5 break-words">
                        <div className="text-xs break-words">
                          <span className="text-slate-600 block text-[11px] break-words font-medium">Identified: {item.identifiedDate}</span>
                          <span className="font-bold text-slate-900 block break-words">SLA Target: {item.targetDate}</span>
                        </div>
                      </td>
                      ...
                      <td className="py-2.5 px-2.5 break-words">
                        {item.status === 'Remediated' ? (
                          ...
                          <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-slate-100 text-slate-800 border border-slate-200 inline-block break-words">
                            {item.timeSinceOpenText}
                          </span>
                        )}
                      </td>
                      ...
                      <td className="py-2.5 px-2.5 max-w-[150px] break-words">
                        <div className="flex items-start gap-1.5 break-words">
                          ...
                          <span className="font-bold text-slate-900 text-xs break-words" title={item.owner}>
                            {item.owner}
                          </span>
                        </div>
                      </td>
                      ...
                      <td className="py-2.5 px-2.5 max-w-[150px] break-words">
                        <div className="flex items-start gap-1.5 break-words">
                          ...
                          <span className="text-slate-700 font-medium text-xs break-words" title={item.accountable}>
                            {item.accountable}
                          </span>
                        </div>
                      </td>
                      ...
                      <td className="py-2.5 px-2.5 break-words">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold inline-block ${
                          item.status === 'Remediated' ? 'bg-emerald-100 text-emerald-800 border border-emerald-200' :
                          item.status === 'Overdue' ? 'bg-rose-100 text-rose-800 border border-rose-200' :
                          item.status === 'In Progress' ? 'bg-indigo-100 text-indigo-800 border border-indigo-200' :
                          item.status === 'Under Review' ? 'bg-amber-100 text-amber-800 border border-amber-200' :
                          'bg-slate-100 text-slate-800 border border-slate-200'
                        }`}>
                          {item.status}
                        </span>
                      ...
                      <td className="py-2.5 px-2.5 text-right break-words" onClick={(e) => e.stopPropagation()}>
                        {item.status !== 'Remediated' ? (
                          ...
                          <span className="text-[10px] text-emerald-700 font-bold flex items-center justify-end gap-0.5">
        ...
        return (
          <div className="bg-slate-900 text-white rounded-xl p-4 border border-slate-800 shadow-sm space-y-3">
            <div className="flex items-center justify-between border-b border-slate-800 pb-2">
              <div className="flex items-center gap-2">
                <span className="font-mono text-xs font-bold text-indigo-300 bg-indigo-950 px-2 py-0.5 rounded border border-indigo-700">
                  {item.id}
                </span>
              ...
              <button
                ...
                className="text-xs text-slate-300 hover:text-white px-2 py-1 rounded bg-slate-800 border border-slate-700 font-semibold"
              >
                Close Details
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
              <div className="bg-slate-800 p-3 rounded-lg border border-slate-700 space-y-1">
                <span className="text-[11px] font-bold text-slate-300 uppercase block">Target Scope & Telemetry</span>
                <p className="font-mono text-slate-100 break-all">{item.assetTarget}</p>
                <p className="text-slate-300 text-xs">Source: {item.telemetrySource}</p>
                {item.complianceImpact && (
                  <p className="text-indigo-300 font-bold text-xs pt-1">
              ...
              <div className="bg-slate-800 p-3 rounded-lg border border-slate-700 space-y-1">
                <span className="text-[11px] font-bold text-slate-300 uppercase block">Governance & Accountability</span>
                <p className="text-slate-100"><strong>Assignee:</strong> {item.owner}</p>
                <p className="text-slate-200"><strong>Accountable VP:</strong> {item.accountable}</p>
                <p className="text-slate-300"><strong>Business Unit:</strong> {item.businessUnit}</p>
                <p className="text-slate-300"><strong>Identified:</strong> {item.identifiedDate} (Target: {item.targetDate})</p>
              </div>

              <div className="bg-slate-800 p-3 rounded-lg border border-slate-700 space-y-1">
                <span className="text-[11px] font-bold text-slate-300 uppercase block">Remediation Action Plan</span>
                <p className="text-slate-100 text-xs leading-relaxed">{item.remediationPlan}</p>
                {item.status !== 'Remediated' && (
                  <button
                    onClick={() => handleRemediate(item)}
